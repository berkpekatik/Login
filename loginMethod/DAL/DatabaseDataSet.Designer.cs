            ...
            public string pw {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'users\' tablosundaki \'pw\' sütunun değeri DBNull.", e);
                    }
                }
                set {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`id` = ?) AND ((? = 1 AND `username` IS NULL) OR (`us" +
                "ername` = ?)) AND ((? = 1 AND `pw` IS NULL) OR (`pw` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`username`, `pw`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `username` = ?, `pw` = ? WHERE ((`id` = ?) AND ((? = 1 AND `us" +
                "ername` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `pw` IS NULL) OR (`pw` = ?" +
                ")))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, pw FROM users";
        ...
        public virtual int Delete(int Original_id, string Original_username, string Original_pw) {
        ...
        public virtual int Update(string username, string pw, int Original_id, string Original_username, string Original_pw) {
            if ((username == null)) {
            ...
            if ((Original_pw == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_pw));
            }
